-- 097_kpi_first_action_min.down.sql — revierte v_soc_kpis quitando first_action_min
-- (CREATE OR REPLACE no permite quitar columnas → DROP + CREATE; sin dependientes).

...
class NetworkDiscoveryJob(Base):
    ...
    detect_new_assets: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
    open_incidents_on_unacked: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)

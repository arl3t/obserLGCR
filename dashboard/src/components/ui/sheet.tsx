...
const sheetVariants = cva(
  "fixed z-50 gap-4 border border-border bg-sidebar p-6 shadow-lg outline-none",
  {
    variants: {
      side: {
        right:
        ...
        left: "inset-y-0 left-0 h-full w-[min(100%,20rem)] border-r data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left",
      },
    },
